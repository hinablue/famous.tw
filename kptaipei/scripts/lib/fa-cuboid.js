...
kp.directive('faCuboid', ["$famous", "$famousDecorator", function ($famous, $famousDecorator) {
  return {
    template: '<div></div>',
    transclude: true,
    scope: true,
        ...
        pre: function($scope, $element, $attrs) {
          ...
          var _resequenceChildren = function() {
            $scope.$$postDigest(function() {
              ...
              _.each(_children, function(child, i) {
              ...
              _.each(sequence, function(child, i) {
          ...
          $famousDecorator.sequenceWith($scope, function(data) {
            _children.push(data);
            _resequenceChildren();
          }, function(child$ScopeId) {
            _children = function(_children) {
              var _ch = [];
              _.each(_children, function(c) {
                if (c.id !== child$ScopeId) {
                  _ch.push(c);
                }
              });
              return _ch;
